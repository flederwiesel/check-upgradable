...
apps=(
	...
	"Google Chrome	96.0.4664.18 (Oct. 21, 2021)	36498a6337566c0d82b8125be77d16c8	https://latestversionof.com/chrome/"
...
#	"gtk2-runtime	3.24.24-2021-01-30	bf989de4faf29a08b39ae207dd6c9c49	https://api.github.com/repos/tschoonj/GTK-for-Windows-Runtime-Environment-Installer/releases/latest| jq -r .published_at"
	...
	"Qt6	6.2.0	e355971a30765deb782dc0e806b2ed24	https://www.qt.io/offline-installers| sed -rn '/qt\\\\/6/ { s:.*(<a.*qt/6.*)</a>.*:\\\\1:g; /-rc[0-9]/!p }'"
	...
	"Wireshark	3.4.9	00c76e6a24884fc0c48f8fe40bfe7010	https://1.eu.dl.wireshark.org/win64/| grep -v 'rc[0-9][0-9]*\.'"
